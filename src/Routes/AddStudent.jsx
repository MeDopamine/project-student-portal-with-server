...
const AddStudent = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`https://portfolio.rwahyus.online/students`);
    ...
    const handleAddData = async (e) => {
        ...
        try {
            ...
            const response = await fetch("https://portfolio.rwahyus.online/add", {
                method: "POST",
                headers: {
                        ...
                        <Flex height="100%" alignItems="center" justifyContent="center">
                            ...
                            >
                                <Progress
                                    ...
                                    mx="5%"
                                    isAnimated></Progress>
                                {step === 1 ? <Form1 passingValue={passingValue} /> : step === 2 ? <Form2 /> : <Form3 />}
